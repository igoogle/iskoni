        ...
        <div class="card">
          <div class="card-thumb">
            ...
            <a href="<?= $arItem["DETAIL_PAGE_URL"] ?>">
              ...
              ?>
              <img class="lazy" src="<?= $arItem["PREVIEW_PICTURE"]["SRC"] ?>" data-src="<?= $arItem["PREVIEW_PICTURE"]["SRC"] ?>"
          ...
          <div class="card-body">
            ...
            <span class="card-price__price">
              ...
              <?if($arItem['PROPERTIES']['PRICE_1']['VALUE']):?>
                <span class="card-price_no">от <?=getPriceFormat($arItem['PROPERTIES']['PRICE_1']['VALUE']);?> р./м²</span>
              <?else:?>
              ...
              <?if($arItem['PROPERTIES']['PRICE_2']['VALUE'] && $arItem['PROPERTIES']['PRICE_2']['DESCRIPTION']):?>
                <div class="additional-price">
                  <span><?=$arItem['PROPERTIES']['PRICE_2']['DESCRIPTION'];?></span> от <?=getPriceFormat($arItem['PROPERTIES']['PRICE_2']['VALUE']);?> р.
                </div>
              <?endif;?>

              <?if($arItem['PROPERTIES']['PRICE_3']['VALUE'] && $arItem['PROPERTIES']['PRICE_3']['DESCRIPTION']):?>
                <div class="additional-price">
                  <span><?=$arItem['PROPERTIES']['PRICE_3']['DESCRIPTION'];?></span> от <?=getPriceFormat($arItem['PROPERTIES']['PRICE_3']['VALUE']);?> р.
                </div>
              <?endif;?>
            ...
            <div class="card-footer">
              ...
              <a class="btn btn-orange js-callback-with-house"
                 ...
                 data-catalog-item-link="https://iskoni.ru<?=$arItem['DETAIL_PAGE_URL'];?>"
              >рассчитайте смету</a>
