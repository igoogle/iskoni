...
<div class="bx-filter <?=$templateData["TEMPLATE_CLASS"]?> <?if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal"?> filter">
  <form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
    ...
    <?
      ...
      {
        if(class_exists('Olepro\Classes\Helpers\MobileDetect') && (Olepro\Classes\Helpers\MobileDetect::getInstance()->isMobile())) {
        ...
        if (
          ...
          continue;
        ?>
        <div class="filter-box bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
          <span class="bx-filter-container-modef"></span>
          <div class="filter-title h6" onclick="smartFilter.hideFilterProps(this)">
            <?=$arItem["NAME"]?>
            <i data-role="prop_angle" class="fa fa-angle-<?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>up<?else:?>down<?endif?>"></i>
          </div>

          <div class="bx-filter-block" data-role="bx_filter_block">
            <div class="bx-filter-parameters-box-container <?if ($arItem["DISPLAY_TYPE"] == "A"):?>d-flex align-items-center justify-content-between<?endif;?>" style="flex-wrap: wrap;" data-role="bx_filter_block">
              <?
                ...
                case "A"://NUMBERS_WITH_SLIDER
                  ?>
                  <div class="bx-filter-parameters-box-container-block bx-left filter-slider-item">
                    <div class="bx-filter-input-container">
                      <input
                        class="min-price filter-slider-input"
                        type="text"
                  ...
                  <div class="bx-filter-parameters-box-container-block bx-right filter-slider-item">
                    <div class="bx-filter-input-container">
                      <input
                        class="max-price filter-slider-input"
                        type="text"
                  ...
                  <div class="bx-ui-slider-track-container">
                    <div class="bx-ui-slider-track" id="drag_track_<?=$key?>">
                      <div class="bx-ui-slider-range" 	id="drag_tracker_<?=$key?>"  style="left: 0;right: 0;">
                        <a class="bx-ui-slider-handle"  style="left:0;" href="javascript:void(0)" id="left_slider_<?=$key?>"></a>
                        <a class="bx-ui-slider-handle" style="right:0;" href="javascript:void(0)" id="right_slider_<?=$key?>"></a>
                      </div>
                      <?
                ...
                ?>
                  <div class="custom-control custom-radio">
                    ...
                    />
                    <label class="custom-control-label" for="<? echo "all_".$arCur["CONTROL_ID"] ?>">
                  ...
                  <div class="custom-control custom-radio">
                    <input
                      ...
                      onclick="smartFilter.click(this)"
                    />
                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="custom-control-label" for="<? echo $ar["CONTROL_ID"] ?>">
                ...
                <?foreach($arItem["VALUES"] as $val => $ar):?>
                  <div class="custom-control custom-checkbox">
                    <input
                      ...
                      onclick="smartFilter.click(this)"
                    />
                    <label data-role="label_<?=$ar["CONTROL_ID"]?>" class="custom-control-label <? echo $ar["DISABLED"] ? 'disabled': '' ?>" for="<? echo $ar["CONTROL_ID"] ?>">
											<span class="bx-filter-param-text" title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?><?
                          if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
                            ?>&nbsp;(<span data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></span>)<?
                          endif;?></span>
